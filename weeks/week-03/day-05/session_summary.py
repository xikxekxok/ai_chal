...
SUMMARY_SYSTEM = """\
Сожми диалог смены приюта opossumов (программа TikTok «Хvostik Clips») в 3–5 коротких
предложений — как волонтёр вспоминает прошлый день: главное помнит, мелочи забывает.
Укажи: идея ролика, на каком этапе остановились, что договорили с ассистентом.
